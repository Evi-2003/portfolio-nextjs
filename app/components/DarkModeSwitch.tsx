...
export default function DarkModeSwitch() {
  ...
  return (
    <button onClick={toggleTheme} className="text-1xl rounded-xl py-2 px-3 shadow-lg font-bold hover:bg-gray-950 bg-yellow-400 dark:hover:bg-yellow-400 dark:bg-black sm:w-auto w-auto mt-5 sm:mt-0">
                      <svg fill="#000000" className="w-6 h-6 fill-white" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
