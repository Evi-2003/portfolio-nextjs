        ...
        <ul className="flex items-center justify-center">
          ...
          <li className="self-end">
            <button onClick={handleMenuToggle} className="block w-8 lg:hidden top-5 right-5 ml-5" aria-label="Open navigatie-menu">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <li className="self-end">
            <button onClick={handleMenuToggle} className="hidden block w-8 lg:hidden top-5 right-5 ml-5" aria-label="Sluit navigatie-menu" aria-label="Close menu">
