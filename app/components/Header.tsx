  ...
  return (
    <header className={'my-10 flex w-full items-center justify-center ' + zenKurenaido.className}>
      <Head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="https://www.eviwammes.dev/favicon-32x32.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="https://www.eviwammes.dev/favicon-16x16.png" />
