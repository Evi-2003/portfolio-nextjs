        ...
        <div class="container sm:w-auto inline-block m-auto p-5 shadow-2xl bg-indigo-100 dark:bg-sky-700 dark:text-white sm:rounded-xl grow">
                ...
                <div class="hidden sm:block sm:flex-grow sm:text-right text-xl sm:m-auto w-full h-[70vh] items-center sm:h-auto" id="nav">
                    ...
                    <ul class="flex sm:inline-flex space-x-5 sm:text-base text-5xl sm:w-auto sm:w-full sm:flex-row flex-col text-center items-center h-[70v] justify-center font-semibold">
                        ...
                        <router-link to="/werkervaring" class="hover:text-white p-2 rounded hover:bg-slate-900 hover:shadow-xl sm:w-auto dark:hover:text-white dark:hover:bg-slate-900">Werkervaring</router-link>
                        <router-link to="/contact" class="sm:text-white p-2 rounded hover:bg-slate-900 hover:shadow-xl sm:bg-sky-500 mx-5 sm:w-auto hover:text-white hover:bg-slate-900 mt-1 sm:mt-0">Contact</router-link>
                        ...
                        <a href="https://github.com/Evi-2003" target="_blank"><button class="text-1xl rounded-xl py-2 px-3 shadow-lg font-bold hover:bg-red-500 sm:w-auto w-auto mt-5 sm:mt-0">
                        ...
                        <a href="https://www.instagram.com/evi.wammes/" target="_blank"><button class="text-1xl rounded-xl py-2 px-3 shadow-lg font-bold hover:bg-purple-400 sm:w-auto w-auto mt-5 sm:mt-0">
                        ...
                        <a href="https://www.linkedin.com/in/eviwammes/" target="_blank"><button class="text-1xl rounded-xl py-2 px-3 shadow-lg font-bold hover:bg-blue-400 sm:w-auto w-auto mt-5 sm:mt-0">
                        ...
                        <a href="https://wa.me/+31640707077" target="_blank"><button class="text-1xl rounded-xl py-2 px-3 shadow-lg font-bold hover:bg-green-400 sm:w-auto w-auto mt-5 sm:mt-0">
